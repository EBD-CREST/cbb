...
#define TEST_NAME           "SetXAttr"
#define TEST_CASE           "01-19"
...
int main() {
  ...
  const char *value = TEST_NAME""TEST_CASE;

  ret = setxattr(TEST2_DATA_01, name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = setxattr(TEST2_DATA_01a, name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = setxattr(TEST2_DATA_01"_aaa", name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = setxattr(TEST2_DATA_01a"_aaa", name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = setxattr(TEST2_DATA_02, name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = setxattr(TEST2_DATA_02a, name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = setxattr(TEST2_DATA_02"_bbb", name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = setxattr(TEST2_DATA_02a"_bbb", name, value, sizeof(value), 0);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
