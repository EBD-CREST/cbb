...
#define TEST_NAME           "Access"
#define TEST_CASE           "01-25"
...
int main() {
  ...
  ret = access(TEST2_DATA_01, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = access(TEST2_DATA_01a, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = access(TEST2_DATA_01"_aaa", mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = access(TEST2_DATA_01a"_aaa", mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = access(TEST2_DATA_02, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = access(TEST2_DATA_02a, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = access(TEST2_DATA_02"_bbb", mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = access(TEST2_DATA_02a"_bbb", mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
