...
#define TEST_NAME           "StatFs"
#define TEST_CASE           "01-15"
...
int main() {
  ...
  ret = statfs(TEST2_DATA_01, &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = statfs(TEST2_DATA_01a, &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = statfs(TEST2_DATA_01"_aaa", &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = statfs(TEST2_DATA_01a"_aaa", &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = statfs(TEST2_DATA_02, &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = statfs(TEST2_DATA_02a, &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = statfs(TEST2_DATA_02"_aaa", &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = statfs(TEST2_DATA_02a"_aaa", &buf);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
