...
#define TEST_NAME           "Create/Close/Rename"
#define TEST_CASE           "02-08"
...
int main() {
  ...
  ret3 = rename(TEST2_DATA_24, TEST2_DATA_24"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);

  ret1 = creat(TEST2_DATA_24a, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = close(ret1);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);
  ret3 = rename(TEST2_DATA_24a, TEST2_DATA_24a"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);

  ret1 = creat("aaa/"TEST2_DATA_24, mode);
  ...
  ret3 = rename("aaa/"TEST2_DATA_24, TEST2_DATA_24"_rename2");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);

  ret1 = creat("aaa/"TEST2_DATA_24a, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = close(ret1);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);
  ret3 = rename("aaa/"TEST2_DATA_24a, TEST2_DATA_24a"_rename2");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);
