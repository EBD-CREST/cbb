...
#define TEST_NAME           "Rename"
#define TEST_CASE           "01-07"
...
int main() {
  ...
  ret = rename(TEST2_DATA_09, TEST2_DATA_09"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = rename(TEST2_DATA_09a, TEST2_DATA_09a"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ...
  ret = rename(TEST2_DATA_10, TEST2_DATA_10"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = rename(TEST2_DATA_10a, TEST2_DATA_10a"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
