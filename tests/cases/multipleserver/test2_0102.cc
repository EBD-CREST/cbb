...
int main() {
  ...
  ret = readlink(TEST2_DATA_03, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_03b, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_03"dummy", buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_03b"dummy", buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);


  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_04, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_04a, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_04"dummy", buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  memset(buf, 0x00, sizeof(buf));
  ret = readlink(TEST2_DATA_04a"dummy", buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
