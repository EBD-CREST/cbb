...
#define TEST_NAME           "Symlink/Unlink"
#define TEST_CASE           "02-17"
...
int main() {
  ...
  ret1 = symlink(TEST2_DATA_35, TEST2_DATA_31);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = unlink(TEST2_DATA_31);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);

  ret1 = symlink(TEST2_DATA_35, TEST2_DATA_31a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = unlink(TEST2_DATA_31a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);

  ret1 = symlink(TEST2_DATA_35, "aaa/"TEST2_DATA_31);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = unlink("aaa/"TEST2_DATA_31);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);

  ret1 = symlink(TEST2_DATA_35, "aaa/"TEST2_DATA_31a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = unlink("aaa/"TEST2_DATA_31a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);

  ret1 = symlink(TEST2_DATA_36, TEST2_DATA_32);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret1);
  ret2 = unlink(TEST2_DATA_32);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret2);

  ret1 = symlink(TEST2_DATA_36, TEST2_DATA_32a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret1);
  ret2 = unlink(TEST2_DATA_32a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret2);

  ret1 = symlink(TEST2_DATA_36, "bbb/"TEST2_DATA_32);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret1);
  ret2 = unlink("bbb/"TEST2_DATA_32);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret2);

  ret1 = symlink(TEST2_DATA_36, "bbb/"TEST2_DATA_32a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret1);
  ret2 = unlink("bbb/"TEST2_DATA_32a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret2);
