...
int main() {
  ...
  ret = utimes(TEST2_DATA_01, times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = utimes(TEST2_DATA_01a, times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = utimes(TEST2_DATA_01"_aaa", times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = utimes(TEST2_DATA_01a"_aaa", times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = utimes(TEST2_DATA_02, times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = utimes(TEST2_DATA_02a, times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = utimes(TEST2_DATA_02"_bbb", times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = utimes(TEST2_DATA_02a"_bbb", times);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
