...
int main() {
  ...
  ret = removexattr(TEST2_DATA_01, name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = removexattr(TEST2_DATA_01a, name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = removexattr(TEST2_DATA_01"_aaa", name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = removexattr(TEST2_DATA_01a"_aaa", name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = removexattr(TEST2_DATA_02, name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = removexattr(TEST2_DATA_02a, name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = removexattr(TEST2_DATA_02"_bbb", name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = removexattr(TEST2_DATA_02a"_bbb", name);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
