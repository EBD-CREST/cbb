...
#define TEST_NAME           "fopen/Flush/fclose"
#define TEST_CASE           "02-11"
...
int main() {
  ...
  ret1 = (fp = fopen(TEST2_DATA_27, "w")) != NULL ? 0: -1;
  ...
  ret1 = (fp = fopen(TEST2_DATA_27e, "w")) != NULL ? 0: -1;
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = fflush(fp);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);
  ret3 = fclose(fp);
