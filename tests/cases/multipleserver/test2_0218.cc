...
#define TEST_NAME           "Link/Unlink"
#define TEST_CASE           "02-18"
...
int main() {
  ...
  ret1 = link(TEST2_DATA_01, TEST2_DATA_33);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = unlink(TEST2_DATA_33);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);

  ret1 = link(TEST2_DATA_01, TEST2_DATA_33a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = unlink(TEST2_DATA_33a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);

  ret1 = link(TEST2_DATA_01, "aaa/"TEST2_DATA_33);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = unlink("aaa/"TEST2_DATA_33);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);

  ret1 = link(TEST2_DATA_01, "aaa/"TEST2_DATA_33a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = unlink("aaa/"TEST2_DATA_33a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);

  ret1 = link(TEST2_DATA_02, TEST2_DATA_34);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret1);
  ret2 = unlink(TEST2_DATA_34);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret2);

  ret1 = link(TEST2_DATA_02, TEST2_DATA_34a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret1);
  ret2 = unlink(TEST2_DATA_34a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret2);

  ret1 = link(TEST2_DATA_02, "bbb/"TEST2_DATA_34);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret1);
  ret2 = unlink("bbb/"TEST2_DATA_34);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret2);

  ret1 = link(TEST2_DATA_02, "bbb/"TEST2_DATA_34a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret1);
  ret2 = unlink("bbb/"TEST2_DATA_34a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret2);
