...
int main() {
  ...
  ret = chown(TEST2_DATA_01, owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = chown(TEST2_DATA_01a, owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = chown(TEST2_DATA_01"_aaa", owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = chown(TEST2_DATA_01a"_aaa", owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = chown(TEST2_DATA_02, owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = chown(TEST2_DATA_02a, owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = chown(TEST2_DATA_02"_bbb", owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = chown(TEST2_DATA_02a"_bbb", owner, group);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
