...
int main() {
  ...
  ret = link(TEST2_DATA_01, TEST2_DATA_11);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = link(TEST2_DATA_01, TEST2_DATA_11b);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = link(TEST2_DATA_01"_aaa", TEST2_DATA_11"_aaa");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = link(TEST2_DATA_01"_aaa", TEST2_DATA_11b"_aaa");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = link(TEST2_DATA_02, TEST2_DATA_12);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = link(TEST2_DATA_02, TEST2_DATA_12a);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = link(TEST2_DATA_02"/bbb", TEST2_DATA_12"_bbb");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = link(TEST2_DATA_02"/bbb", TEST2_DATA_12a"_bbb");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
