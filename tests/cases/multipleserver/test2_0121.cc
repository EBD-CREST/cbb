...
#define TEST_NAME           "ListXAttr"
#define TEST_CASE           "01-21"
...
int main() {
  ...
  ret = listxattr(TEST2_DATA_01, list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);
  ret = listxattr(TEST2_DATA_01a, list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret);

  ret = listxattr(TEST2_DATA_01"_aaa", list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);
  ret = listxattr(TEST2_DATA_01a"_aaa", list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret);

  ret = listxattr(TEST2_DATA_02, list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);
  ret = listxattr(TEST2_DATA_02a, list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN3, ret);

  ret = listxattr(TEST2_DATA_02"_bbb", list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
  ret = listxattr(TEST2_DATA_02a"_bbb", list, sizeof(list));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN4, ret);
