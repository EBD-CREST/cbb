...
#define TEST_NAME           "Create/Write/Close"
#define TEST_CASE           "02-02"
...
int main() {
  int ret1, ret2, ret3;
  mode_t mode = S_IRWXU;
  char buf[1024] = "Test Data Write";

  ret1 = creat(TEST2_DATA_22, mode);
  ...
  ret1 = creat(TEST2_DATA_22b, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret1);
  ret2 = write(ret1, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret2);
  ret3 = close(ret1);
  ...
  ret1 = creat("aaa/"TEST2_DATA_22, mode);
  ...
  ret1 = creat("aaa/"TEST2_DATA_22b, mode);
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret1);
  ret2 = write(ret1, buf, sizeof(buf));
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN2, ret2);
  ret3 = close(ret1);
