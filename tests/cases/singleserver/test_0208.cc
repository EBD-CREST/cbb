...
int main() {
  ...
  ret3 = rename(TEST_DATA_24, TEST_DATA_24"_rename");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);

  ret1 = creat("aaa/"TEST_DATA_24, mode);
  ...
  ret3 = rename("aaa/"TEST_DATA_24, TEST_DATA_24"_rename2");
  output_test_results(TEST_NAME, TEST_CASE, TEST_CASE_PATTERN1, ret3);
